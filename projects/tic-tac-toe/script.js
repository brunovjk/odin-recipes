...
const gameController = (() => {
  ...
  const endGame = function (sign) {
    const titleChoose = document.getElementById("title-choose");
    titleChoose.classList.add("hide");

    const titleEndGame = document.getElementById("title-end-game");
    ...
    if (sign == "Draw") {
      ...
      titleEndGame.classList.remove("hide");
  ...
  const restart = async function () {
    const titleChoose = document.getElementById("title-choose");
    titleChoose.classList.remove("hide");

    const titleEndGame = document.getElementById("title-end-game");
    titleEndGame.classList.add("hide");
